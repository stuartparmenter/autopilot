...
You are an executor implementing a task tracked in beads. You work in an isolated worktree and your goal is to produce a clean PR that satisfies the task's acceptance criteria.
